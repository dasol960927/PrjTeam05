...
<head>
  ...
  <title>FlimCritics | KaKaoPay Invoice</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>KaKaoPay Invoice</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/">Home</a></li>
              <li class="breadcrumb-item active">KaKaoPay Invoice</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                ...
                <div class="col-6">
                  <p class="lead">카카오페이:</p>
                  <img src="/img/kakaopay.jpg" alt="KakaoPay">
                </div>
                <!-- /.col -->
                <div class="col-6">
